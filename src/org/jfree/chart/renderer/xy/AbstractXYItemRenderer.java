...
public abstract class AbstractXYItemRenderer extends AbstractRenderer
    ...
    /**
     * Draws a vertical line on the chart to represent a 'domain marker'.
     *
     * @param g2  the graphics device.
     * @param plot  the plot.
     * @param valueAxis  the domain axis.
    ...
    public void drawDomainMarker(Graphics2D g2,
        ...
        PlotOrientation preferred = PlotOrientation.HORIZONTAL;
        RectangleEdge axisEdge = plot.getDomainAxisEdge();

        // Avoid duplicate code
        marker.drawAxis(g2, plot, valueAxis, dataArea, preferred, axisEdge);
    }
    ...
    public void drawRangeMarker(Graphics2D g2,
        ...
        PlotOrientation preferred = PlotOrientation.VERTICAL;
        RectangleEdge axisEdge = plot.getRangeAxisEdge();
